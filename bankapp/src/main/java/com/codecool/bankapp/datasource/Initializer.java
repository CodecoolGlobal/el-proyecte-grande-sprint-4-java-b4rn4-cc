...
public class Initializer {
    ...
    private void init() {
        User user1 = User.builder().name("Bandi").password("12")
                .userID(UUID.fromString("11111111-2222-3333-4444-555555555555")).address("City of Westminster, Downing Street 10.").build();
        User user2 = User.builder().name("Adam").password("123")
                .address("1111 Budapest, Csirke utca 7.").userID(UUID.fromString("99999999-2222-3333-4444-555555555555")).build();
